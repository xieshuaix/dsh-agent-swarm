...
Then use the swarm tool to recruit 4 subagents, each with model deepseek-v4-flash and reasoningEffort off. Give each subagent a rolePrompt that states its role (e.g. "You are the HTML builder"), and have each write a quick 2-3 step plan first, then do its part:
