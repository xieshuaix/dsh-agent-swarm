window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function SwarmView(props) {
      ...
      /** Render one agent's prompt-driven extras (role prompt, todos, plan, artifacts). */
      function agentDetail(a) {
        ...
        if (Array.isArray(a.plan) && a.plan.length > 0) {
          parts.push(h("div", { key: "plan" }, a.plan.map(function (p) {
        ...
        if (Array.isArray(a.todos) && a.todos.length > 0) {
          parts.push(h("div", { key: "todos" }, a.todos.map(function (td) {
        ...
        if (Array.isArray(a.artifacts) && a.artifacts.length > 0) {
          parts.push(h("div", { key: "artifacts" }, a.artifacts.map(function (art) {
            return h("div", { className: "das-artifact", key: art.id }, art.path || art.name);
          })));
        }
          ...
          h("div", { className: "das-list" }, agents.map(function (a) {
            return h("div", { className: "das-row", key: a.id },
              h("div", { className: "das-row-main" },
                h("div", { className: "das-row-name" }, a.name),
                h("div", { className: "das-row-meta" }, (a.role || "") + (a.task ? " — " + a.task : "")),
    ...
    module.exports = { name: "dsh-agent-swarm", inject: ["slots", "locale"], apply };
